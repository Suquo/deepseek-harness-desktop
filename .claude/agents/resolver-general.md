...
7. Branch prefix `claude/`, worktrees under `C:\Users\chidi\.dsh-resolver-worktrees\`, dev ports 3400+; never touch the operator's app or other lanes' branches (`pm/*`, `up/*`, `dg/*`).
