...
**PAUSED — OWNER HALT 2026-09-02 ~19:10 local (CPU pressure; suquo + tsc continue). No lane spawns until admin relays a resume ruling.** Resume state:
...
- **Lane C / D:** FREE (unchanged). Codex sessions exited; panes w4:p2/p3 idle shells. RM loop STOPPED; RM session idle.
