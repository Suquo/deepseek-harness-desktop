...
- **Lane A (general, `claude/*`)**: gen-16 (Codex) delivered #78 (PR #82). **BUSY — gen-18 (CODEX `dsh-lane-a`, w4:p2) resuming #81 / PR #85 fix cycle 1** (declared `dshReleaseMatrix`; gen-17's unpushed fix commits inherited). Queue after: #30 (per TRIAGE.md) → #83 → #46.
...
- **In flight: #81 (Lane A gen-18, PR #85 APPROVE-PENDING-CI @8dd23538, merge chain armed on run 33653558823) · #62 (Lane B gen-19, RULED Option A default-deny allowlist with data table + census fence; implementing).**
