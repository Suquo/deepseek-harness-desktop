...
- **Lane A (general, `claude/*`)**: gen-14 (Codex) delivered #70 (PR #77). **BUSY — gen-15 (CODEX `dsh-lane-a`, w4:p2, Approve-for-me preset) on #73** (platform-independent `verify:notices` + committed-file fence). Queue after: #78 → #46 → #30.
...
- **In flight: #73 (Lane A gen-15) · #54 (Lane B gen-16, PR #79 REQUEST CHANGES: close keyword, patch hygiene, restored-turn grounding; issue stays pending-live).**
