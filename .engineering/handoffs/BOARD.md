...
**Workspace etiquette (owner 2026-09-02):** agent test launches go to Hyprland ws6-9 only (rules auto-place them); ws1-5 and ws10 are the owner's. Prefer headless; never move/focus a headed window; report any stray window's class/title to admin. Full text in repo-manager-charter.md.
